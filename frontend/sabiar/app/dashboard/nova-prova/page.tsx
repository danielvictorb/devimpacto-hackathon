...
import { criarProva, criarQuestao, listarTurmas } from "@/lib/api";
...
export default function NovaProvaPage() {
  ...
  // Step 1: Turma
  const [turmaSelecionada, setTurmaSelecionada] = useState<string | null>(null); // UUID agora
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const prova = await criarProva({
        ...
        subject: disciplina,
        exam_date: dataProva,
        period_type: periodoTipo || undefined,
        period_number: periodoNumero ? parseInt(periodoNumero) : undefined,
      ...
      for (let i = 0; i < questoes.length; i++) {
        ...
        await criarQuestao({
          exam_id: prova.id,
          question_number: i + 1,
          question_type: q.tipo === "multipla" ? "multiple_choice" : "essay",
          points: q.peso,
          options: q.alternativas,
          expected_answer: q.tipo === "multipla" ? q.respostaCorreta! : "",
          grading_criteria: q.rubrica,
        });
      }
      ...
      alert("❌ Erro ao criar prova. Verifique se o backend está rodando!");
    }
  };
            ...
            {loadingTurmas ? (
              ...
              <div className="py-12 text-center">
                ...
                <p className="mb-4 text-sm text-muted-foreground">
                  Crie uma turma primeiro antes de criar uma prova
                </p>
              </div>
            ) : (
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                <Label htmlFor="titulo">
                  Título da Prova <span className="text-destructive">*</span>
                </Label>
                <Input
                  id="titulo"
            ...
            <CardContent className="space-y-4">
              {!uploadedFile ? (
                ...
                <div className="flex flex-col items-center justify-center py-12">
                  ...
                  <h3 className="mb-2 font-semibold">Processando com OCR...</h3>
                  <p className="text-sm text-muted-foreground">
          ...
          {showAddQuestao && (
            <Card className="border-secondary">
              <CardHeader>
                ...
                <CardDescription>Preencha os dados da questão</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">

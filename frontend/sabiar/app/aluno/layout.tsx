...
const navigation = [
  { name: "Início", href: "/aluno/dashboard", icon: IconLayoutDashboard },
  { name: "Minhas Provas", href: "/aluno/provas", icon: IconClipboardList },
  { name: "Desempenho", href: "/aluno/desempenho", icon: IconChartBar },
  { name: "Perfil", href: "/aluno/perfil", icon: IconUser },
];
...
export default function AlunoLayout({
  ...
  const isLoginPage = pathname === "/aluno";

  // Se for página de login, não mostrar layout
  if (isLoginPage) {
    return <>{children}</>;
  }
